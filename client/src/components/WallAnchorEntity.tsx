...
const INNER_SPHERE_COLOR = getPlayerHex("RED");

export function WallAnchorEntity({ position = [0, 0, 0], personality }: WallAnchorEntityProps) {
    const pointsRef = useRef<THREE.Points>(null);
    const sphereRef = useRef<THREE.Mesh>(null);
    const isFirstFrame = useRef(true);
    const innerColorHex = INNER_SPHERE_COLOR;
